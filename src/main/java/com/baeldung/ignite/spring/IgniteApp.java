...
//        DatasetWrapperRepository datasetWrapperRepository = context.getBean(DatasetWrapperRepository.class);
...
//        IgniteApp igniteApp = new IgniteApp();
//        igniteApp.getUsingTheCache(employeeDTO.getId());
    }
